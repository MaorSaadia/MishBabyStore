      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Alert className="mb-4 bg-cyan-50 border-cyan-200">
          ...
          <AlertDescription className="text-cyan-700">
            Due to recent tariff changes, we now charge a $9.99 shipping fee for
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-2 text-gray-600">
                  ...
                  <li>
                    $9.99 shipping fee for United States (due to recent tariff
                    changes)
                  </li>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  there is a $9.99 shipping fee due to recent tariff changes.
