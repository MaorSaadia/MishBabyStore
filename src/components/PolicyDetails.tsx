  ...
  const policies = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "We offer shipping to most countries worldwide. Delivery times typically range from 7-21 business days, depending on your location and product availability.",
        },
      ],
    },
    {
