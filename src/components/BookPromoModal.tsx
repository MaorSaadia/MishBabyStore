  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Top Section: Image */}
        <div className="flex items-center justify-center p-6 lg:p-8 bg-slate-200/40 relative">
        ...
        <div className="p-6 lg:p-8 flex flex-col justify-center -mt-2">
          <div className="mb-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm">
                  ...
                  day. You&apos;ll have a clear plan, from your morning analysis
                  to executing your trades with confidence.
                </p>
              </div>
            </div>
          </div>
